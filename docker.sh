...
docker run -it --rm -e AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID -e AWS_SECRET_KEY=$AWS_SECRET_ACCESS_KEY -v `pwd`/:/home/dev/jmesnil.net -p 4242:4242 -w /home/dev/jmesnil.net jmesnil/jmesnil.net
